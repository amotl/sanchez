...
'''
    ...
    @see: Recipe 574451: Handling ANSI Terminal
    @see: http://code.activestate.com/recipes/574451-handling-ansi-terminal/

    @see: http://pueblo.sourceforge.net/doc/manual/ansi_color_codes.html
    @see: http://www.networksorcery.com/enp/protocol/telnet.htm

    Alternative:
    @see: http://www.koders.com/kv.aspx?fid=71D85FBF5623300245AE08308F17402B4A934049&s=timer%3C/span%3E
